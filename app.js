...
const CHARACTER_FIELD_DEFS = {
    ...
    species: {
        ...
        tags: ["human", "elf", "demon", "cyborg", "orc", "dwarf", "vampire", "cat-person", "dragonkin", "angel / celestial", "android", "mermaid / siren", "tiefling", "werewolf / lycan", "fae / fairy", "goblin", "centaur", "elemental entity", "extraterrestrial alien", "satyr"]
    },
    skinTone: {
        group: "Body",
    ...
    otherBody: {
        ...
        tags: ["witch-like long nails", "scars on back", "glowing veins", "feathered wings", "robotic arm", "demon horns", "prehensile tail", "cybernetic eye implant", "scaly dragon skin patches", "glowing energy runes", "four-armed (multiple limbs)", "shadowy aura", "crystal growths", "pointed claws", "mechanical spine cyberware", "translucent skin"]
    },
    ...
    hair: {
        ...
        tags: ["long black wavy hair", "short messy blonde hair", "silver pixie cut", "bald", "braided dreadlocks", "neon blue mohawk", "fiery red bob cut", "afro puff hairstyle", "waist-length white hair", "cyberpunk undercut", "slicked-back dark hair", "curly shoulder-length hair", "pastel pink twin tails", "top knot samurai bun", "braided crown updo", "wild voluminous mane", "buzz cut"]
    },
    faceShape: {
        group: "Head",
        label: "Face shape",
        placeholder: "e.g. long face, No tattoos on face",
        tags: ["long face", "sharp jawline", "round face", "oval face", "high cheekbones", "square jawline", "heart-shaped face", "chiseled facial structure", "soft rounded chin", "diamond face shape", "hollow sunken cheeks", "broad forehead", "delicate refined features", "rugged weathered visage", "prominent jawbone", "youthful soft contours"]
    },
    eyes: {
        group: "Head",
        label: "Eyes",
        placeholder: "e.g. black eyes",
        tags: ["black eyes", "piercing blue", "glowing yellow-green", "heterochromia", "cat eyes", "deep emerald green", "warm honey amber", "glowing red cyborg optic", "amethyst purple eyes", "smoldering dark brown", "milky blind white eyes", "starry cosmic pupils", "expressive hazel eyes", "heavy-lidded sleepy eyes", "glowing cyan iris", "slanted feline gaze"]
    },
    nose: {
        group: "Head",
        label: "Nose",
        placeholder: "e.g. hooked nose",
        tags: ["hooked nose", "button nose", "straight nose", "pierced nose", "aquiline hawk nose", "upturned nose", "crooked broken nose", "broad flat nose", "slender narrow bridge", "septum ring piercing", "small delicate nose", "prominent Roman nose", "snub nose", "double pierced nostril", "freckled nose bridge"]
    },
    ears: {
        group: "Head",
        label: "Ears",
        placeholder: "e.g. Small, pointy and bifurcated",
        tags: ["small, pointy and bifurcated", "elf pointed ears", "cat ears", "pierced lobes", "long drooping elf ears", "industrial piercing ears", "fin-like aquatic ears", "furry fox ears", "multiple cuff earrings", "round human ears", "pointed goblin ears", "tapered fae ears", "gauge stretched earlobes", "feather earring adorned", "subtle pointed tips"]
    },
    mouth: {
        group: "Head",
        label: "Mouth",
        placeholder: "e.g. sly confident smirk",
        tags: ["sly confident smirk", "fanged grin", "full lips", "stern expression", "pouted red lipstick", "thin tight-lipped scowl", "warm gentle smile", "lip ring piercing", "playful tongue out", "snarl revealing sharp teeth", "subtle neutral pout", "bitten lower lip", "stitched mouth appearance", "beaming radiant smile", "cynical half-smile"]
    },
    headAccessories: {
        group: "Head",
        label: "Head accessories",
        placeholder: "e.g. crown of short gnarled twigs",
        tags: ["grecian laurel wreath crown", "horned helmet", "glowing halo", "bandana", "steampunk goggles", "golden ornate tiara", "wide-brimmed witch hat", "cybernetic visor", "flower crown", "samurai kabuto helmet", "headphones around neck", "jeweled headband", "tactical balaclava", "feathered headdress", "pointy wizard hat", "spiked gothic crown"]
    },
...
const SCENE_FIELD_TAGS = {
    'scene-positioning': ["Character 1 left foreground, Character 2 right background", "side by side facing each other", "one standing behind the other", "back to back", "Character 1 seated, Character 2 standing beside", "mirrored symmetrical positioning", "Character 1 center focus, Character 2 lurking in shadows behind", "Character 1 & 2 in intense face-to-face eye contact", "Character 1 lying on ground looking up at standing Character 2", "Character 1 sitting at desk, Character 2 leaning on doorframe", "Character 1 holding Character 2 in a dramatic embrace", "Character 1 in foreground action, Character 2 watching from distance", "diagonal arrangement across frame", "Character 1 on upper balcony, Character 2 in courtyard below", "trio formation: center leader flanked by two companions", "Character 1 kneeling before seated Character 2", "staggered depth perspective positioning"],
    'scene-other-details': ["small demonic imp over shoulder", "floating magic runes", "dust motes in sunbeam", "sparkling embers", "ghostly transparent silhouette", "floating glowing holographic UI windows", "swirling falling cherry blossom petals", "heavy falling rain drops & water splashes", "flock of crows flying in background", "crackling arc lightning bolts", "floating crystal shards", "dense volumetric fog and ground mist", "glowing neon signs reflecting in puddles", "floating mechanical drone observer", "swirling autumn leaves", "dramatic shadows cast on wall"],
    'scene-background': ["busy atmospheric tavern", "futuristic neon city street", "enchanted bioluminescent forest", "cozy dimly lit library", "dramatic mountain peak", "ancient stone cathedral with stained glass windows", "cyberpunk underground bar with holo-displays", "sun-drenched tropical beach with turquoise water", "ruined gothic castle under full moon", "spaceship bridge with view of star nebula", "steampunk clockwork workshop filled with gears", "mystical underwater coral reef palace", "post-apocalyptic overgrown city ruins", "vibrant Japanese night market alleyway", "desert dunes under starry night sky", "grand royal palace throne room"],
    'scene-camera': ["shot from wrist up", "close-up portrait", "wide cinematic shot", "low angle dramatic view", "over-the-shoulder shot", "bird's-eye high angle view", "extreme macro close-up on eyes", "dramatic worm's-eye camera perspective", "dutch angle tilted composition", "full-body portrait shot", "cinematic 35mm shallow depth-of-field", "fisheye lens ultra-wide view", "medium waist-up shot", "first-person point-of-view perspective", "telephoto lens compressed background shot", "panoramic wide landscape framing"],
...
function generateRandomPrompt() {
    ...
    // Determine which character fields to fill across all characters in this prompt
    const activeFieldKeys = {};
    Object.keys(CHARACTER_FIELD_DEFS).forEach(fieldKey => {
        // 55% chance to fill this field across all characters
        activeFieldKeys[fieldKey] = Math.random() < 0.55;
    });
    ...
    for (let i = 1; i <= numChars; i++) {
        ...
        Object.keys(CHARACTER_FIELD_DEFS).forEach(fieldKey => {
            const def = CHARACTER_FIELD_DEFS[fieldKey];
            if (activeFieldKeys[fieldKey] && def.tags && def.tags.length > 0) {
